...
(function () {
    ...
    function init() {
        ...
        // ---- Submit ----
        // TODO(SMTP): replace this body with a real fetch() POST to the
        // mail endpoint once it exists. Everything downstream of it
        // (loading state, success screen, reset) is already wired to
        // whatever Promise this returns.
