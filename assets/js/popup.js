...
(function () {
    ...
    function init() {
        ...
        // Mouse-follow glow tracking — same --x/--y custom-property recipe
        // main.js wires up for every .cta-btn on the page, repeated here
        // rather than relying on that wiring: main.js's own
        // querySelectorAll('.cta-btn') runs once at parse time, before
        // this button exists (it's injected above, on DOMContentLoaded),
        // so it would never pick this one up.
